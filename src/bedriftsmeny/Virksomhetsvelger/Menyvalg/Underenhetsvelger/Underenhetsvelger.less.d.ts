...
interface CssExports {
  ...
  'screenXsMax': string;
  'underenhet': string;
  'underenhetsvelger': string;
  'underenhetsvelger__button': string;
  'underenhetsvelger__button__chevron--apen': string;
  'underenhetsvelger__button__chevron--lukket': string;
  'underenhetsvelger__button__label': string;
  'underenhetsvelger__menyvalg-wrapper--apen': string;
  'underenhetsvelger__menyvalg-wrapper--lukket': string;
  'valgtjuridiskenhet': string;
  'white': string;
}
