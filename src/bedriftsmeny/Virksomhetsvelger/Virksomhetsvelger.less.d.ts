...
interface CssExports {
  ...
  'dropdownmeny-elementer': string;
  'dropdownmeny-elementer-wrapper': string;
  'fokusFarge': string;
  ...
  'virksomhetsvelger__dropdown--apen': string;
  'virksomhetsvelger__dropdown--lukket': string;
  'virksomhetsvelger__wrapper': string;
  'white': string;
}
